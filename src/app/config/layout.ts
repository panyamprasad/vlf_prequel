...
export class LayoutConfig implements ConfigModel {
    public config: any = {
        ...
        // == Base Layout
        self: {
            layout: 'wide', // Page width type from available options: fluid|boxed
        ...
        header: {
            ...
            self: {
                ...
                logo: {
                    dark: './assets/images/logo/',
                    light: './assets/images/logo/'
                },
                partnerLogoLink: 'https://s3.amazonaws.com/creditsnap/'
            },
