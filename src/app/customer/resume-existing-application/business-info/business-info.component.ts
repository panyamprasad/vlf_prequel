...
export class BusinessInfoComponent implements OnInit, OnDestroy {
    ...
    public businessPurpose = [
        { business: 'Buy Equipment', image: 'assets/icons/wrench.png' },
        { business: 'Working Capital', image: 'assets/icons/project-management.png' },
        { business: 'Debt Refinance', image: 'assets/icons/borrow.png' },
        { business: 'Inventory', image: 'assets/icons/check-list.png' },
        { business: 'Buy Existing Business', image: 'assets/icons/online-shop.png' },
        { business: 'Payroll', image: 'assets/icons/payroll.png' },
        { business: 'State a Franchise', image: 'assets/icons/hand.png' },
        { business: 'Real Estate', image: 'assets/icons/mortgage.png' }
    ];
