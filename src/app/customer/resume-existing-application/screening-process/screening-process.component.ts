...
@Component({
    selector: 'screening-process',
    templateUrl: './screening-process.component.html',
    styleUrls: ['./screening-process.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, UpperCasePipe]
})
export class ScreeningProcessComponent implements OnInit, OnDestroy {
    ...
    onSubmit() {
        this.router.navigate(["/businessDuration"]);
    }
