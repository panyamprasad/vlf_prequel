...
@Component({
    selector: 'business-duration',
    templateUrl: './business-duration.component.html',
    styleUrls: ['./business-duration.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, UpperCasePipe]
})
export class BusinessDurationComponent implements OnInit, OnDestroy {
    ...
    public duration = [
        { duration: '<2', period: 'Years' },
        { duration: '2-5', period: 'Years' },
        { duration: '5-7', period: 'Years' },
        { duration: '>7', period: 'Years' }
    ];
