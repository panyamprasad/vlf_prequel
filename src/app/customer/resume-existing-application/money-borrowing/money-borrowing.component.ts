...
@Component({
    selector: 'money-borrowing',
    templateUrl: './money-borrowing.component.html',
    styleUrls: ['./money-borrowing.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    providers: [DatePipe, UpperCasePipe]
})
export class MoneyBorrowingComponent implements OnInit, OnDestroy {
    ...
    selectedItem = null;
    public duration = [
        { amount: '$5K - $10K', image: 'assets/icons/cash.png' },
        { amount: '$11K - $20K', image: 'assets/icons/money.png' },
        { amount: '$21K - $25K', image: 'assets/icons/cash-bag.png' },
        { amount: '>$25K', image: 'assets/icons/money-bag.png' }
    ];
