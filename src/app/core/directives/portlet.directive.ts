...
import {LayoutRefService} from '../util-services/layout/layout-ref.service';
import * as objectPath from 'object-path';
import {LayoutConfigService} from '../util-services/layout-config.service';
...
export class PortletDirective implements AfterViewInit, OnDestroy, OnInit {
    ...
    ngAfterViewInit(): void {
        ...
        if (objectPath.get(this.options, 'headAuto')) {
            this.class.add('m-portlet--head-auto');
        } else if (objectPath.get(this.options, 'headLarge')) {
